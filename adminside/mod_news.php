                        ...
                        <div class="col-md-6">
                            ...
                            <?php
                                ...
                                if($isEdit){?> 
                                    ...
                                    <textarea name="item_desc" value="<?= $post_caption ?>" id="post_caption" placeholder="Enter Post Caption" class="form-control" required> <?= $item_desc ?></textarea>
                                    
                                    <label for="">
                                        Post URL
                                    </label>
                                    <input type="text" value="<?= $post_url ?>" name="post_url" placeholder="Enter Link to Post" class="form-control" required>  
